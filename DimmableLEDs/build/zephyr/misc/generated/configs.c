...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_MODEL_GROUP_COUNT, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_STRDUP_MAX_STRING, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_STRDUP_BUF_COUNT, 20);
